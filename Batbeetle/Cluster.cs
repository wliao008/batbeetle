...
namespace Batbeetle
{
    ...
    /// <summary>
    /// This is migrated from https://github.com/antirez/redis-rb-cluster/blob/master/crc16.rb
    /// </summary>
    public class Crc16
    {
        private static readonly ushort[] XModemCRC16LookUp = new ushort[]{
        ...
        public static ushort GetCrc16(byte[] bytes)
        {
            ushort crc = 0;
